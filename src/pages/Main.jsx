        ...
        <Wrapper className="section-wrap">
          <Content className="section">
            <Wrapper className="txt-box-01">
              ...
              <Wrapper className="txt-area">
                <H2 className="h2-txt01">누구나 손쉽게, 온라인<br />
                  롤링 페이퍼를 만들 수 있어요</H2>
          ...
          <Content className="section reverse-section">
            <Wrapper className="txt-box-02">
              ...
              <Wrapper className="txt-area">
                <H2 className="h2-txt02">서로에게 이모지로 감정을<br />
                표현해보세요</H2>
                <P className="p-txt02">롤링 페이퍼에 이모지를 추가할 수 있어요.</P>
              </Wrapper>
            </Wrapper>
            <Content className="img"></Content>
          </Content>
        </Wrapper>
        <Wrapper className="buttonWrapper"><PrimaryButton width="280px" onClick={test}>구경해보기</PrimaryButton></Wrapper>
      </Wrapper>
    );
  }
